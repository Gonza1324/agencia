  ...
  public: {
    Tables: {
      ...
      subagent_user_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "subagent_user_links_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "subagent_user_links_subagent_id_fkey"
            columns: ["subagent_id"]
            isOneToOne: false
            referencedRelation: "subagents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "subagent_user_links_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "subagent_user_links_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      can_access_subagent: { Args: { p_subagent_id: string }; Returns: boolean }
